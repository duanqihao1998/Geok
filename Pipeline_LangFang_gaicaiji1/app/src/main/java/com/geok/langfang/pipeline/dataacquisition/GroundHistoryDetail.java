 ...
 * 
 */
public class GroundHistoryDetail extends Activity implements android.view.View.OnClickListener {
...
//		weather.setText("天气：" + data.getWeather());
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 3:// 删除
			...
			AlertDialog.Builder builder = new Builder(GroundHistoryDetail.this);
			builder.setTitle("提示");
