 ...
 * 
 */
public class NaturalHistoryDetail extends Activity implements android.view.View.OnClickListener {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 3:// 删除
			...
			AlertDialog.Builder builder = new Builder(NaturalHistoryDetail.this);
			builder.setTitle("提示");
