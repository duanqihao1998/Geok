...
public class AbstractDemoChart {
	 ...
	 * @return the category series
	 */
	public MultipleCategorySeries buildMultipleCategoryDataset(String title, List<String[]> titles,
			List<double[]> values) {
	 ...
	 */
	public DefaultRenderer buildCategoryRenderer(int[] colors, String title) {
