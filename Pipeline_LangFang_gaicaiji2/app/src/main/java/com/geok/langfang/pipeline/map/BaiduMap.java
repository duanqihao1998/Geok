...
public class BaiduMap extends Activity implements OnClickListener, MKOfflineMapListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		while (cursor.moveToNext()) {
			...
			Log.i("baidu",lon+"---"+lat+"---"+userid+"---"+isupload+"--日期--"+date);
...
//		}
		...
		List<GpsHui> gpsHuis = Json.gpsHuis;
		if(gpsHuis.size()==0){
	...
	void initView() {
		...
		map_other_move.setOnClickListener(new OnClickListener() {
	...
	public void alertOfflineMap() {
		Builder builder = new Builder(BaiduMap.this);
	...
	public void onClick(View v) {
		...
		case R.id.map_monitor:
			...
			linearLayout.setBackgroundDrawable(getResources().getDrawable(R.color.blue));
